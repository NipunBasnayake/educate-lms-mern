        ...
        <div className="w-full h-full flex items-center justify-center bg-black bg-opacity-50 rounded-md">
          <div className="text-white p-6 bg-opacity-75 rounded-md">
            ...
            <p className="mt-4 text-lg leading-relaxed">
              ...
              boost your career and skills in various fields of study. We
              offer flexible learning paths, expert instructors,
              <br /> and a supportive community that ensures your success.
              Whether you're looking to start a new career or enhance your
              existing skills, we have the tools and resources you need.
            </p>

            <div className="mt-4">
              <button className="border border-indigo-700 bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700 transition duration-300">
                Get Started
              </button>
